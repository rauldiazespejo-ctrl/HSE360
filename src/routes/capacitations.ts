...
export let capsDB: any[] = [
  ...
  { id: 9, nombre: 'HIC — Hipobaria Intermitente Crónica y Trabajo en Altura', tipo: 'HIC', fecha: '2026-02-05', duracion_horas: 4, relator: 'Dr. R. Valenzuela — Médico Ocupacional OAL', institucion: 'OAL / IST', trabajadores_convocados: 14, trabajadores_capacitados: 13, aprobados: 13, reprobados: 0, vigencia_meses: 12, proxima_fecha: '2027-02-05', estado: 'vigente', contenidos: ['¿Qué es la hipobaria intermitente crónica?','Fisiopatología de la hipoxia a gran altitud','Síntomas de alarma: mal de altura, poliglobulia, apnea','Límites hematocrito: hombres ≤ 21%, mujeres ≤ 19%','Régimen de turnos y tiempo recuperación nivel del mar','Aclimatación progresiva para nuevos ingresantes','Exámenes de salud requeridos (hemograma, ECG, oximetría)','Autocuidado: hidratación, sueño, restricción alcohol en altura'], documentos: ['lista_asistencia_hic_feb2026.pdf','programa_hic_2026.pdf'], areas_cubiertas: ['Producción — Faena Altura'], observaciones: 'Protocolo según Guía Técnica MINSAL 2013 + Circ. SUSESO 3838/2024. Requiere IRL firmado por cada trabajador expuesto (DS 44 Art.15).' },
  { id: 10, nombre: 'HUMOS — Metales, Metaloides y Humos de Soldadura', tipo: 'HUMOS', fecha: '2026-03-10', duracion_horas: 3, relator: 'Higienista Industrial B. Alarcón — ACHS', institucion: 'ACHS', trabajadores_convocados: 9, trabajadores_capacitados: 8, aprobados: 8, reprobados: 0, vigencia_meses: 12, proxima_fecha: '2027-03-10', estado: 'vigente', contenidos: ['Tipos de humos metálicos: Fe, Mn, Cr+6, Ni, Pb, Cd, As, Cu, Zn','Fiebre por humos metálicos: síntomas y prevención','Metales cancerígenos (Grupo 1 IARC): Cr+6, As, Cd','Límites permisibles (LPP) DS 594 Anexo N°1','Ventilación local exhaustora (VLE): importancia y verificación','Selección y uso correcto de EPR: P100, media cara, cara completa','Fit Test: prueba de ajuste positivo/negativo','Monitoreo biológico: qué se mide y cuándo'], documentos: ['lista_asistencia_humos_mar2026.pdf','protocolo_humos_606_2023.pdf'], areas_cubiertas: ['Producción — Taller Soldadura', 'Mantenimiento'], observaciones: 'Protocolo según Res. Exenta N°606/2023 MINSAL + Circ. SUSESO 3838/2024. Enfoque especial en cancerígenos Cr+6, As, Cd. IRL requerido (DS 44 Art.15).' },
]
