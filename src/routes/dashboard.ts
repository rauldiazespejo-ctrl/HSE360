...
export const accidentabilidadDB: any = {
  ...
  // KPIs del dashboard — actualizables por el Superadmin desde el panel
  kpi_override: {
    trabajadores_total: 0,
    trabajadores_activos: 0,
    con_examenes_pendientes: 0,
    con_protocolos_activos: 0,
    protocolos_al_dia: 0,
    protocolos_por_vencer: 0,
    protocolos_criticos: 0,
    protocolos_cumplimiento_pct: 0,
    examenes_vigentes: 0,
    examenes_por_vencer: 0,
    examenes_vencidos: 0,
    epp_items_criticos: 0,
    epp_items_bajo_stock: 0,
    epp_entregas_pendientes: 0,
    epp_valor_inventario: 0,
    cap_vigentes: 0,
    cap_por_vencer: 0,
    cap_vencidas: 0,
    cobertura_irl: 0,
