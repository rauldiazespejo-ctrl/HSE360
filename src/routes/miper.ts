...
export let miperDB: any[] = [
  ...
  { id: 8, area: 'Taller Soldadura', puesto: 'Soldador', peligro: 'Proyección de partículas calientes / arco eléctrico', tipo_riesgo: 'Mecánico / Físico', consecuencia: 'Quemaduras, lesión ocular, electrocución', probabilidad: 3, severidad: 4, nr: 12, nivel: 'Importante', medidas_existentes: 'Careta autodimable, guantes, delantal cuero', medidas_propuestas: 'Revisión semestral estado EPP, biombo protector para otros trabajadores', protocolo: null, responsable: 'Prevencionista + Mantenimiento', plazo: '2026-04-15', estado_accion: 'Pendiente', ultima_revision: '2026-02-14' },
  { id: 9, area: 'Taller Soldadura', puesto: 'Soldador', peligro: 'Gases y humos de soldadura (humos metálicos, CO, ozono)', tipo_riesgo: 'Químico', consecuencia: 'Neumoconiosis, asma ocupacional, síndrome de humo metálico', probabilidad: 3, severidad: 4, nr: 12, nivel: 'Importante', medidas_existentes: 'EPR, ventilación general', medidas_propuestas: 'Extracción local en cada punto de soldadura, evaluación ambiental de humos', protocolo: null, responsable: 'Prevencionista', plazo: '2026-06-30', estado_accion: 'Pendiente', ultima_revision: '2026-02-14' },
  { id: 10, area: 'Administración / Call Center', puesto: 'Operadora Call Center', peligro: 'Uso intensivo de la voz (> 6h/día) + ruido ambiental', tipo_riesgo: 'Físico / Ergonómico', consecuencia: 'Nódulos vocales, disfonía crónica, enfermedad profesional', probabilidad: 2, severidad: 3, nr: 6, nivel: 'Moderado', medidas_existentes: 'Headset, hidratación, evaluación fonoaudiológica', medidas_propuestas: 'Insonorización sala call, control ruido < 65 dB, pausas vocales', protocolo: 'VOZ', responsable: 'Fonoaudióloga + Adm.', plazo: '2026-09-30', estado_accion: 'En proceso', ultima_revision: '2026-01-15' },
]
