...
export let workersDB = [
  ...
  { id: 4, rut: '16.234.567-8', nombres: 'Ana Patricia', apellidos: 'López Vega', cargo: 'Soldadora Auxiliar', area: 'Producción', fecha_ingreso: '2022-01-10', estado: 'activo', sexo: 'F', fecha_nacimiento: '1995-02-28', email: 'alopez@empresa.cl', telefono: '+56923456789', mutualidad: 'Mutual', turno: 'Diurno', contrato: 'Plazo Fijo', protocolos_activos: ['PSICOSOCIAL','HUMOS'], observaciones: 'Expuesta a humos de soldadura (Mn, Fe, Cr+6). EPR P100 asignado.' },
  ...
  { id: 9, rut: '10.555.666-7', nombres: 'Sofía Alejandra', apellidos: 'Castillo Mora', cargo: 'Minera de Interior', area: 'Producción', fecha_ingreso: '2020-03-01', estado: 'activo', sexo: 'F', fecha_nacimiento: '1988-05-12', email: 'scastillo@empresa.cl', telefono: '+56911223344', mutualidad: 'IST', turno: 'Turno Rotativo', contrato: 'Indefinido', protocolos_activos: ['HIC','PSICOSOCIAL','TMERT'], observaciones: 'Faena en altura 3.800 msnm. Régimen 7x7. Control hematocrito semestral.' },
...
export let examenesDB = [
  ...
  { id: 9, worker_id: 4, tipo: 'Monitoreo Biológico — Metales', fecha: '2026-01-15', resultado: 'Mn urinario 4.2 µg/g creat (LPP: 5.0). Fe2O3 ambiente 1.8 mg/m³. Dentro de límites.', vigencia: '2027-01-15', estado: 'vigente', centro_medico: 'ACHS — Lab. Toxicología Ocupacional', protocolo: 'HUMOS', profesional: 'TM B. Alarcón — Higienista Industrial' },
